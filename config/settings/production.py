...
ALLOWED_HOSTS = env.list("DJANGO_ALLOWED_HOSTS", default=["weathervis.uib.no"])
...
DEFAULT_FROM_EMAIL = env(
    "DJANGO_DEFAULT_FROM_EMAIL", default="weathervis <noreply@weathervis.uib.no>"
)
